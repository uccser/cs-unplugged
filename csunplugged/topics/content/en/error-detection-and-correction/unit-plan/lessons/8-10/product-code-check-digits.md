...
{image file-path="img/topics/barcode-2-step-7.png"}
...
There needs to be a system around the checksum to make sure that the people using it know when the checksum worked and when it didn’t.
