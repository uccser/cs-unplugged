...
-   Set the variable “bit value” to 1 and find the smallest “bit value” which
    is larger than “decimal number” by multiplying “bit value” by 2
    (Use the `scratch:() * ()` block under “Operators” to multiply the “bit
    value” by 2) until it is larger than “decimal number”.
...
-   Now divide the “bit value” by 2 and check if “decimal number” is greater
    ...
    If it is, play a high note and subtract “bit value” from the “decimal number”.
