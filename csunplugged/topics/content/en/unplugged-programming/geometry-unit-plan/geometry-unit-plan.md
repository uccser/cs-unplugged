...
Giving sequential instructions are an important element of all programming languages, and so the Geometry programming activities lays the foundation for understanding more conventional languages.
