...
class AllCurriculumIntegrationViewTest(BaseTestWithDB):
    ...
    def test_all_curriculum_integration_view_with_multiple_integration(self):
        topic = self.test_data.create_test_topic(1)
        self.test_data.create_test_integration(topic, 1)
        self.test_data.create_test_integration(topic, 2)
        self.test_data.create_test_integration(topic, 3)
    ...
    def test_all_curriculum_integration_view_order(self):
        topic_1 = self.test_data.create_test_topic(1)
        topic_2 = self.test_data.create_test_topic(2)
        self.test_data.create_test_integration(topic_2, 3)
        self.test_data.create_test_integration(topic_2, 2)
        self.test_data.create_test_integration(topic_2, 1)
        self.test_data.create_test_integration(topic_1, 4)
        self.test_data.create_test_integration(topic_1, 5)
        self.test_data.create_test_integration(topic_1, 6)
