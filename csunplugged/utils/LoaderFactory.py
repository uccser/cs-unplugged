...
class LoaderFactory:
    ...
    def create_lessons_loader(self, load_log, lessons_structure, topic, unit_plan, BASE_PATH):
        """Create lessons loader."""
        return LessonsLoader(load_log, lessons_structure, topic, unit_plan, BASE_PATH)
